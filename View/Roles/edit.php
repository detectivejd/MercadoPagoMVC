<h3><i class="fa fa-angle-right"></i>&nbsp;Editar Rol nro <?php echo $rol->getId(); ?></h3>
<form class="form-horizontal style-form" method="post" action="index.php?c=roles&a=edit&id=<?php echo \App\Session::get("id"); ?>">
    <div class="row mt">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="txtnombre" class="form-control" autofocus="autofocus" tabindex="1" value="<?php echo $rol->getNombre(); ?>" />
                    </div>
                </div>
            </div>
        </div>
