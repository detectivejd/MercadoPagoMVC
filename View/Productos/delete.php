...
<form class="form-horizontal style-form" method="post" action="index.php?c=productos&a=delete&id=<?php echo \App\Session::get("id"); ?>">
    <div class="row mt">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="showback">
                <h4><i class="fa fa-angle-right"></i>&nbsp;¿Deseas eliminar el producto: <?php echo $producto->getNombre(); ?>?</h4>
                <br />
